...
About:
🧠 My product designer brain thrives on making complex systems feel simple and accessible, driving business impact through purposeful and elegant solutions.
🧡 My creative technologist heart bridges vision and reality through technical prototyping, bringing ambitious ideas to life through rapid learning and experimentation.
...
- Think Big Move Fast (Strategic Thinking and Innovation)
    ...
    * Her proactive approach and willingness to ask the right questions have significantly contributed to the team's ability to tackle new challenges efficiently. Quote from a karma sent from her product partner  “Lauren's blend of creativity, collaboration, and strategy were exceptional, allowing us to preserve the core user experience while cutting our development effort in half. Her strategic approach not only streamlined our project but also showcased the innovation possible within constraints”
...
- Resourceful: When we worked on implementing/fixing Hotjar, Lauren helped me debug the issues and she offered a few ideas for why it might not be working. She also got me in touch with people who had institutional knowledge and were able to assist further. With mostly Lauren’s help, we got the Hotjar working.
...
- Lauren is one of the most talented and well-rounded designers I’ve ever worked with. She excels at every stage of the design process, from product research and discovery, prototyping and user testing, and collaborating with developers and even implementing code herself. She’s able to design for a range of audiences and projects, such as a metagame and interactive eReader for a K-8 literacy product, a QR code login system for kindergarten students, and enterprise software for internal team members.
- In addition to being highly organized and self-driven, Lauren is an amazing teammate. She has strong visual design sensibilities as well as technical abilities that enable her to create unified design systems, to improve processes for documenting and delivering assets, and to partner with engineers on animation pipelines and prototypes. She’s also hardworking and able to complete high-quality designs at various stages of fidelity (wireframes, user flows, game assets, animations, etc.) under extremely tight deadlines.
...
- EDUCATION
    MFA  ∙  Pratt Institute  ∙  2015—2017
    Major: Interactive Technology
    Focus: HCI, Creative coding

    BA  ∙   Fujian University of Technology  ∙  2008—2012
    Major: Advertising Design
    Focus: Graphic design, 2D animation

- EXPERIENCE
    Lead product designer  ∙  Zillow  ∙  2023—Present
    ▪︎ Leading design for Zillow In-app Message that enables buyers to seamlessly communicate with agents and loan officers to get a home
    ▪︎ Drove the redesign for agent directory for all platforms from early definition through product launch, shaped 1 year design roadmap. Delivered V1 that made CEO say “gorgeous design”
    ▪︎ Designed and built prototypes in code for loan officers to gain real buyer insight that got leadership to form an officially team to develop

    Senior product designer, video call ∙  Meta  ∙  2022—2023
    ▪︎ Drove stakeholder alignment towards a cohesive end-of-call survey for Messenger, Instagram, and Facebook, scoped and shaped research strategy, developed concepts and prototypes
    ▪︎ Supported designers from Messenger, Instagram, Facebook, AR and VR teams to best integrate video calling experience on each platform

    Product designer, activation  ∙  Uber  ∙  2021—2022
    ▪︎ Led the product design strategy and end-to-end execution for the Uber Eats merchant early life-cycle across the globe
        ▫ Enabled the rapid business expansion by delivering the first-to-market Point Of Sale integration, self-signup for grocery and retails, and tiered merchant pricing 
        ▫ Led the initiative for navigation redesign and merchant onboarding 
    ▪︎ Created the Merchant team’s figma library with Uber’s design system;
    ▪︎ Built Figma plugins that eases designer’s workflow on creating interactive components

    Senior product designer ∙  Amplify  ∙  2017— 2021
    ▪︎ Created educational games for millions of kids on mobile, tablet and web from 0 to 1; shaped process and practices for the entire pillar
        ▫ Established the visual language system for kids UI, which was adopted by all K-5 student facing products across the company
        ▫ Developed game concepts and defined game UX, created rich prototypes; analyzed data and research, provided high quality design under tight deadline and limited resources
    ▪︎ Unleveled the design team by hosting workshops on UX analytics, coding for designers, and interactive animation
    ▪︎ Designed, animated, and built a dynamic character customization system for web and mobile for an educational game for K-5 kids
    ▪︎ Created an optimized end-to-end pipelines for building dynamic web animation resulting in 50% faster development turnaround time, created custom tools for animators to manage states with Lottie
    ▪︎ Built accessible components for the design system with semantic HTML, production-ready SCSS, and vanilla JavaScript to be integrated into React engineers’ development process

    Interactive designer ∙  Sony Music Entertainment ∙ 2017
    ▪︎ Provided a suite of promotional solutions for artists’ new albums by
    designing and developing interactive campaign sites

    Web Developer ∙  LUSHmedia ∙ 2016—2017
    ▪︎ Developed the interface, interaction, and API integration for clients’ homepages and eCommerce sites using HTML, CSS, and Javascript
...
blurb:  As Uber Eats’ business has scaled up significantly in the past a few years, we identified opportunities to improve the existing self-sign-up experience to drive leading selection by seamlessly acquiring and onboarding all merchants toward taking their first trip with Uber Eats.
...
“Your 👃 Knows” is a web app that lets users interact using their nose. It utilizes the webcam to track nose movements, and allows people who may not have easy use of their hands to perform basic web interactions such as click, hover, drag, and drop.
